...
var displayMap = function displayMap(locations) {
  ...
  // );
  mapboxgl.accessToken = 'pk.eyJ1Ijoibm5ja2dyIiwiYSI6ImNrOHE3eHplODAweHMzaG1uZGw4Y2hqN3gifQ.D-oN8zYoPSYC_FZsQz7IlA';
  var map = new mapboxgl.Map({
    container: 'map',
...
var stripe = Stripe('pk_test_1uFS328FUHlSvEL92QvyPQQT00RDbHFfVL');
